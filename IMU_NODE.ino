...
#define FIREBASE_HOST "chironsystem.firebaseio.com" //Change the name of your Firebase project
#define WIFI_SSID "Nome da Rede" // Change the name of your WIFI
#define WIFI_PASSWORD "Senha da Rede" // Change the password of your WIFI
...
//  TWBR = 12;  // 400 kbit/sec I2C speed
  ...
  if (c == 0xFF) // WHO_AM_I was changed from 0x71 to 0xFF, start the code and change WHO_AM_I value to the value of your IMU   
  {  
...
Firebase.pushFloat("ay",ay);
Firebase.pushFloat("az",az);
Firebase.pushFloat("gx",gx);
Firebase.pushFloat("gy",gy);
Firebase.pushFloat("gz",gz);
Firebase.pushFloat("mx",mx);
Firebase.pushFloat("my",my);
Firebase.pushFloat("mz",mz);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  // Link to the website used to find the declination https://www.ngdc.noaa.gov/geomag-web/
...
//    Serial.println("rt: "); Serial.println((float) sumCount / sum, 2); Serial.println(" Hz"); 
    ...
    Firebase.pushFloat ("yaw",yaw+180);
    Firebase.pushFloat("pitch",pitch);
    Firebase.pushFloat("roll",roll);
    delay(100);
